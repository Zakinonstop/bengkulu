...
<html lang="en">
  ...
  <body>
    <section id="main" style="display: block;">
        <div class="container-fluid layout-baru" style="background-color: #242948; height: 240cm;">
         <div class="d-flex justify-content-between navbar-1-baru">
            <div class="d-flex justify-content-center">
                <div class="">
                    <img src="<?= base_url('assets/img/logo.png')?>" alt="" width="500" height="500">
                </div>
                <div class="klu-kiri">
            ...
            <div class="d-flex justify-content-center">
                <div class="">
                    <img src="<?= base_url('assets/img/logo-bengkulu.png')?>" alt="" width="500" height="500">
                </div>
                <div class="klu-kanan">
         ...
         <div class="d-flex justify-content-center navbar-3-baru">
            <div class="d-flex justify-content-center">
                <div class="jam-text text-center">
                    <span class="text-white jam-text-value"><?= substr($getApi->data->waktu,0, -10)?><br><?= substr($getApi->data->waktu, -5)?> WIB</span>
                </div>
            </div>    
         </div>
         ...
         <div class="d-flex justify-content-center navbar-4-baru">
            <div class="d-flex justify-content-center">
                <div class="number-text text-center" style="background-color: green;">
                    <h1 class="number-text-number text-center text-white" style="font-size: 40vw;"><?= $getApi->data->o3?></h1>
                </div>
            </div>    
         </div>
         ...
         <div class="row navbar-6-baru">
            <div class="col-kiri col-6" style="padding-right: 10cm;">
            <div class="tes">
                <div class="param-text">
                    <span class="text-left text-white" style="font-size: 3.5vw; font-weight: 600;">Parameter Kritis</span>
                </div>
                <div class="d-flex justify-content-end value-text">
                    <span class="" style="font-size: 8vw; font-weight: 600; color: yellow; margin-top: -1cm" align="right">O<sub>3</sub></span>
                </div>
            </div>
            </div>
            <div class="col-kanan col-6" style="padding-left: 10cm;">
                <div class="tes2">
                    <div class="param-text">
                        <span class="text-left text-white" style="font-size: 3.5vw; font-weight: 600;">Nilai Konsentrasi</span>
                    </div>
                    <div class="d-flex justify-content-end value-text" style="margin-top: -3cm;">
                        <span class="konsentrasi-text" style="font-size: 8vw; font-weight: 600; color: yellow;" align="right"><?= $getApi->data->o3; ?></span>
                    </div>
                    <div class="d-flex justify-content-end value-text" style="margin-top: -5cm;">
                        <span class="text-white" style="font-size: 3vw;" align="right">ug/m<sup>3</sup></span>
                    </div>
                </div>
            </div>
         </div>
        ...
        $('document').ready(function () {
            ...
            function changeColor() {
                ...
                if (category == 1) {
                    ...
                    $('.number-text-number').css('font-size', '');
                    $('.number-text-number').css('font-size', '30vw');
                    $('.number-text-number').css('margin-top', '1cm');
